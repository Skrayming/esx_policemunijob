...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = 'Tenue Manche Courte Bleu', value = 'tenu_lspd' },

                { label = 'Tenue Manche Courte Blanche', value = 'tenu_lspd2' },

		{ label = 'Tenue Velo', value = 'tenu_velo' },

		{ label = 'Tenue Manche Longue Bleu', value = 'tenu_ma' },

		{ label = 'Tenue Manche Longue Blanche', value = 'tenu_ma2'},
		...
		{ label = _U('bullet3_wear'), value = 'bullet3_wear' },
                ...
                { label = _U('helmet1_wear'), value = 'helmet1_wear' },
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
			...
			if Config.MaxInService ~= -1 then
				...
				ESX.TriggerServerCallback('esx_service:isInService', function(isInService)
					...
					if isInService then
						...
						TriggerServerEvent('esx_service:notifyAllInService', notification, 'pm')



						TriggerServerEvent('esx_service:disableService', 'pm')

						TriggerEvent('esx_pmjob:updateBlip')
		...
		if      data.current.value == 'helmet1_wear' or
			...
			data.current.value == 'tenu_ma2' or

                        data.current.value == 'tenu_lspd2' or

                        data.current.value == 'tenu_velo' or
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			...
			if type == 'car' then
				...
				shopCoords = Config.PmStations[station].Vehicles[partNum].InsideShop
			...
			elseif type == 'helicopter' then
				...
				shopCoords = Config.PmStations[station].Helicopters[partNum].InsideShop
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('esx_pmjob:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	...
	local spawnPoints = Config.PmStations[station][part][partNum].SpawnPoints
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_pmjob:buyJobVehicle', function (bought)
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pm_actions', {
		...
		elements = {
			...
			{label = '<span style="color:#0cc00;">Poser/Récupérer votre radar', value = 'radar'},
		...
		if data.current.value == 'citizen_interaction' then
			...
			if PlayerData.job and PlayerData.job.name == 'pm' and PlayerData.job.grade_name == 'chef' or PlayerData.job.grade_name == 'boss' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						...
						TriggerServerEvent('esx_pmjob:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
					...
					elseif action == 'handcuff' then
						...
						--TriggerServerEvent('esx_pmjob:handcuff', GetPlayerServerId(closestPlayer))
						...
						if distance <= 2.0 then
							...
							TriggerServerEvent('esx_pmjob:requestarrest', target_id, playerheading, playerCoords, playerlocation)
					...
					elseif action == 'handcuff2' then
						...
						TriggerServerEvent('esx_pmjob:requestrelease', target_id, playerheading, playerCoords, playerlocation)
					...
					elseif action == 'drag' then
						...
						TriggerServerEvent('esx_pmjob:drag', GetPlayerServerId(closestPlayer))

					elseif action == 'put_in_vehicle' then

						TriggerServerEvent('esx_pmjob:putInVehicle', GetPlayerServerId(closestPlayer))

					elseif action == 'out_the_vehicle' then

						TriggerServerEvent('esx_pmjob:OutVehicle', GetPlayerServerId(closestPlayer))
					...
					if amount == nil or amount <= 0 then
						...
						if closestPlayer == -1 or closestDistance > 3.0 then
							...
							Citizen.CreateThread(function()
								...
								TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(closestPlayer), 'society_pm', 'pm', amount)
		...
		elseif data.current.value == 'pm_equipement' then
			...
			if grade == 'recruit' then
				...
				table.insert(elements, {label = ('Equipement'), value = 'equipement_cadet'})

			elseif grade == 'officer' then

				table.insert(elements, {label = ('Equipement'), value = 'equipement_officier'})

			elseif grade == 'sergeant' then

				table.insert(elements, {label = ('Equipement'), value = 'equipement_sergeant'})

			elseif grade == 'lieutenant' then

				table.insert(elements, {label = ('Equipement'), value = 'equipement_lieutenant'})

			elseif grade == 'boss' then

				table.insert(elements, {label = ('Equipement'), value = 'equipement_cmd'})
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pm_equipement', {
				...
				if action == 'equipement_cadet' then
					...
					ESX.ShowAdvancedNotification('Police Municpale INFO', 'Armurie Police Municipale', 'Voila ton équipement, le perd pas.', 'CHAR_CALL911', 1)
...
function pm_radar()
    ...
    if isRadarPlaced then -- remove the previous radar if it exists, only one radar per cop
        ...
        if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), RadarPos.x, RadarPos.y, RadarPos.z, true) < 0.9 then -- if the player is close to his radar
            ...
            AddTextComponentString("~r~Vous n'?es pas ?cot?de votre Radar !")
...
function OpenIdentityCardMenu(player)
	...
	ESX.TriggerServerCallback('esx_pmjob:getOtherPlayerData', function(data)
	...
	ESX.TriggerServerCallback('esx_pmjob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search', {
			...
			if data.current.value then
				...
				TriggerServerEvent('esx_pmjob:confiscatePlayerItem', GetPlayerServerId(player), data.current.itemType, data.current.value, data.current.amount)
...
function OpenFineCategoryMenu(player, category)
	...
	ESX.TriggerServerCallback('esx_pmjob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
			...
			if Config.EnablePlayerManagement then
				...
				TriggerServerEvent('esx_billing:sendBill1', GetPlayerServerId(player), 'society_pm', _U('fine_total', data.current.fineLabel), data.current.amount)
...
function LookupVehicle()
...

	{
		...
		if data.value == nil or length < 2 or length > 13 then
			...
			ESX.TriggerServerCallback('esx_pmjob:getVehicleFromPlate', function(owner, found)
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_pmjob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			TriggerServerEvent('esx_pmjob:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenVehicleInfosMenu(vehicleData)
	...
	ESX.TriggerServerCallback('esx_pmjob:getVehicleInfos', function(retrivedInfo)
...
function OpenGetWeaponMenu()
	...
	ESX.TriggerServerCallback('esx_pmjob:getArmoryWeapons', function(weapons)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon', {
			...
			ESX.TriggerServerCallback('esx_pmjob:removeArmoryWeapon', function()
...
function OpenPutWeaponMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon', {
		...
		ESX.TriggerServerCallback('esx_pmjob:addArmoryWeapon', function()
...
--			ESX.TriggerServerCallback('esx_pmjob:buyWeapon', function(bought)
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('esx_pmjob:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					TriggerServerEvent('esx_pmjob:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('esx_pmjob:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					TriggerServerEvent('esx_pmjob:putStockItems', itemName, count)
...
AddEventHandler('esx:setJob', function(job)
	...
	TriggerServerEvent('esx_pmjob:forceBlip')
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	...
	if PlayerData.job and PlayerData.job.name == 'pm' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_pmjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_pmjob:hasExitedMarker', function(station, part, partNum)
...
AddEventHandler('esx_pmjob:hasEnteredEntityZone', function(entity)

	local playerPed = PlayerPedId()



	if PlayerData.job and PlayerData.job.name == 'pm' and IsPedOnFoot(playerPed) then
...
AddEventHandler('esx_pmjob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_pmjob:handcuff')

AddEventHandler('esx_pmjob:handcuff', function()
...
RegisterNetEvent('esx_pmjob:unrestrain')

AddEventHandler('esx_pmjob:unrestrain', function()
...
RegisterNetEvent('esx_pmjob:drag')

AddEventHandler('esx_pmjob:drag', function(copId)
...
RegisterNetEvent('esx_pmjob:putInVehicle')

AddEventHandler('esx_pmjob:putInVehicle', function()
...
RegisterNetEvent('esx_pmjob:OutVehicle')

AddEventHandler('esx_pmjob:OutVehicle', function()
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.PmStations) do
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if PlayerData.job and PlayerData.job.name == 'pm' then
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					...
					TriggerEvent('esx_pmjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
				...
				TriggerEvent('esx_pmjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
	...
	while true do
		...
		if closestDistance ~= -1 and closestDistance <= 3.0 then
			...
			if LastEntity ~= closestEntity then
				...
				TriggerEvent('esx_pmjob:hasEnteredEntityZone', closestEntity)
			...
			if LastEntity then
				...
				TriggerEvent('esx_pmjob:hasExitedEntityZone', LastEntity)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and PlayerData.job and PlayerData.job.name == 'pm' then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					...
					TriggerEvent('esx_society:openBossMenu', 'pm', function(data, menu)
		...
		if IsControlJustReleased(0, 167) and not isDead and PlayerData.job and PlayerData.job.name == 'pm' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'pm_actions') then
...
AddEventHandler('renfort:setBlip', function(coords, raison)
	...
	if raison == 'petit' then
		...
		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Demande de renfort', 'Demande de renfort demandé.\nRéponse: ~g~CODE-2\n~w~Importance: ~g~Légère.', 'CHAR_CALL911', 8)
...
RegisterNetEvent('pm:InfoService')

AddEventHandler('pm:InfoService', function(service, nom)

	if service == 'prise' then

		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)

		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Prise de service', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-8\n~w~Information: ~g~Prise de service.', 'CHAR_CALL911', 8)
		Wait(1000)
	...
	elseif service == 'fin' then
		...
		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Fin de service', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-10\n~w~Information: ~g~Fin de service.', 'CHAR_CALL911', 8)		Wait(1000)
	...
	elseif service == 'pause' then
		...
		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Pause de service', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-6\n~w~Information: ~g~Pause de service.', 'CHAR_CALL911', 8)		Wait(1000)
	...
	elseif service == 'standby' then
		...
		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Mise en standby', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-12\n~w~Information: ~g~Standby, en attente de dispatch.', 'CHAR_CALL911', 8)		Wait(1000)
	...
	elseif service == 'control' then
		...
		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Control routier', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-48\n~w~Information: ~g~Control routier en cours.', 'CHAR_CALL911', 8)		Wait(1000)
	...
	elseif service == 'refus' then
		...
		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Refus d\'obtempérer', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-30\n~w~Information: ~g~Refus d\'obtempérer / Délit de fuite en cours.', 'CHAR_CALL911', 8)		Wait(1000)
	...
	elseif service == 'arrestation' then
		...
		ESX.ShowAdvancedNotification('GN INFORMATIONS', '~b~Arrestation en cours', 'Agent: ~g~'..nom..'\n~w~Code: ~g~10-31\n~w~Information: ~g~Arrestation en cours.', 'CHAR_CALL911', 8)		Wait(1000)
...
RegisterNetEvent('esx_pmjob:updateBlip')

AddEventHandler('esx_pmjob:updateBlip', function()
...
AddEventHandler('playerSpawned', function(spawn)
	...
	TriggerEvent('esx_pmjob:unrestrain')



	if not hasAlreadyJoined then

		TriggerServerEvent('esx_pmjob:spawned')
...
AddEventHandler('onResourceStop', function(resource)
	...
	if resource == GetCurrentResourceName() then
		...
		TriggerEvent('esx_phone:removeSpecialContact', 'pm')
...
RegisterNetEvent('esx_pmjob:getarrested')

AddEventHandler('esx_pmjob:getarrested', function(playerheading, playercoords, playerlocation)
...
RegisterNetEvent('esx_pmjob:doarrested')

AddEventHandler('esx_pmjob:doarrested', function()
...
RegisterNetEvent('esx_pmjob:douncuffing')

AddEventHandler('esx_pmjob:douncuffing', function()
...
RegisterNetEvent('esx_pmjob:getuncuffed')

AddEventHandler('esx_pmjob:getuncuffed', function(playerheading, playercoords, playerlocation)
    ...
    while true do
        ...
        if isRadarPlaced then
            ...
            if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), RadarPos.x, RadarPos.y, RadarPos.z, true) > 100 then -- if the player is too far from his radar
                ...
                AddTextComponentString("~r~Vous ?es parti trop loin de votre Radar !")
        ...
        if isRadarPlaced then
            ...
            if veh ~= nil then
                ...
                if vehSpeedKm < maxSpeed then
                    ...
                    info = string.format("~b~V?icule  ~w~ %s ~n~~b~Plaque    ~w~ %s ~n~~y~Km/h        ~g~%s", vehDesc, vehPlate, math.ceil(vehSpeedKm))

                else

                    info = string.format("~b~V?icule  ~w~ %s ~n~~b~Plaque    ~w~ %s ~n~~y~Km/h        ~r~%s", vehDesc, vehPlate, math.ceil(vehSpeedKm))
                    ...
                    LastInfo = string.format("~b~V?icule  ~w~ %s ~n~~b~Plaque    ~w~ %s ~n~~y~Km/h        ~r~%s", LastVehDesc, LastPlate, math.ceil(LastSpeed))
