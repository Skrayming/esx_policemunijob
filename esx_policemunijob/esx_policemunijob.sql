...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('pm',0,'recruit','Stagiaire',20,'{}','{}'),
	('pm',1,'officer','Titulaire',40,'{}','{}'),
	('pm',2,'sergeant','Brigadier',60,'{}','{}'),
	('pm',2,'sergeant','Brigadier Chef',60,'{}','{}'),
	('pm',4,'lieutenant','Chef de service',85,'{}','{}'),
	('pm',5,'boss','Directeur',100,'{}','{}')
;
